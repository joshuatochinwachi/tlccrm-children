      ...
      {activePreview && (
        ...
        >
          ...
          <div
            ...
            className="relative max-w-4xl my-auto w-full flex flex-col justify-center items-center py-4"
          >
            {activePreview.type === "image" ? (
              ...
              <div className="relative w-full max-h-[70vh] flex flex-col items-center justify-center space-y-3">
                <video
                  src={activePreview.url}
                  controls
                  autoPlay
                  playsInline
                  preload="auto"
                  className="rounded-2xl max-w-full max-h-[65vh] border border-white/10 bg-black shadow-2xl"
                />
              </div>
            )}
          </div>
